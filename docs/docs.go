            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handler.UnreadActivityResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
        ...
        "/expenses/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Updated expense info",
                        "name": "expense",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/groups/{id}/import": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Parsed rows and column-to-member mapping",
                        "name": "import",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/groups/{id}/import/preview": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "file",
                        "description": "Expense history CSV",
                        "name": "file",
                        "in": "formData",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/domain.ImportPreview"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/groups/{id}/spending.xlsx": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Calendar year — pairs with month",
                        "name": "year",
                        "in": "query"
                    },
                    {
        ...
        "/receipts/scan": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "The scanning group's currency (ISO 4217) — tells the model which decimal/thousands-separator convention to expect. Defaults to the app's default currency if omitted.",
                        "name": "currency",
                        "in": "formData"
                    }
                ],
    ...
    "definitions": {
        "domain.ActivityEvent": {
            ...
            "properties": {
                ...
                "amount": {
                    "description": "cents — 0 for comments",
                    "type": "integer"
                },
                "category": {
                    "description": "Category is the expense's category slug (empty for settlements and\ncomments) so the feed can show the same icon the group history and\ndetail views do.",
                    "type": "string"
                },
                "currency": {
                    "type": "string"
                ...
                "parent_type": {
                    "description": "ParentType and ParentTitle are set only for \"comment\" events: which\nkind of thing (and its title/description) the comment was left on, so\nthe feed can render \"commented on \u003cParentTitle\u003e\".",
                    "type": "string"
                },
                "title": {
                    "description": "Title is the expense's description, the \"X paid Y\" line for a\nsettlement, or the comment's own text for a comment event.",
                    "type": "string"
                },
                "type": {
                    "description": "\"expense\" | \"settlement\" | \"comment\"",
                    "type": "string"
                },
                "your_share": {
                    "description": "cents — 0 for comments",
        ...
        "domain.ImportPreview": {
            ...
            "properties": {
                ...
                "rows": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/domain.ImportRow"
                    }
                },
                "skipped_rows": {
                    "type": "integer"
        ...
        "handler.AddCommentRequest": {
            ...
            "properties": {
                "body": {
                    "type": "string",
                    "example": "Can we split this differently?"
                }
            }
        },
        ...
        "handler.ImportRequest": {
            ...
            "properties": {
                "member_mapping": {
                    "description": "MemberMapping maps a CSV member-column name (from the preview's\nmember_columns) to the group member's user ID it corresponds to.",
                    "type": "object",
                    "additionalProperties": {
                        "type": "integer"
                    }
        ...
        "handler.UnreadActivityResponse": {
            "type": "object",
            "properties": {
                "count": {
                    "type": "integer"
